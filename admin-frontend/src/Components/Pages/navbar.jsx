  ...
  return (
    <header className="nav">
      <div className="nav__inner">
        <NavLink to="/" className="nav__brand">BahiRoom Admin</NavLink>

        {user && (
          <nav className="nav__links">
            <NavLink to="/" className="nav__link">Dashboard</NavLink>
            <NavLink to="/clients" className="nav__link">Clients</NavLink>
            <NavLink to="/hotels" className="nav__link">Hotels</NavLink>
